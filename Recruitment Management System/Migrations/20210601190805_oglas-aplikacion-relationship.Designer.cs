...
namespace Recruitment_Management_System.Migrations
{
    ...
    [Migration("20210601190805_oglas-aplikacion-relationship")]
    partial class oglasaplikacionrelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LokacijaOglasiTable", b =>
                {
                    ...
                    b.HasKey("LokacijaId", "OglasId");

                    b.HasIndex("OglasId");

                    b.ToTable("LokacijaOglasiTable");
                });
            ...
            modelBuilder.Entity("OglasiTableProfilAplikanta", b =>
                {
                    ...
                    b.ToTable("OglasiTableProfilAplikanta");
                });
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.Aplikacija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("MotivacionoPismo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.Lokacija", b =>
                {
                    ...
                    b.Property<int?>("ProfilKompanijaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.OglasiTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PocetakPrijave")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pozicija")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ProfilKompanijeId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProfilKompanijeId1");

                    b.HasIndex("StatusId");

                    b.ToTable("OglasiTable");
                });
            ...
            modelBuilder.Entity("LokacijaOglasiTable", b =>
                {
                    b.HasOne("RMSLibrary.Models.DBModel.Lokacija", null)
                        .WithMany()
                        .HasForeignKey("LokacijaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RMSLibrary.Models.DBModel.OglasiTable", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.Aplikacija", b =>
                {
                    ...
                    b.HasOne("RMSLibrary.Models.DBModel.OglasiTable", "oglas")
                        .WithMany("Aplikacija")
                        .HasForeignKey("oglasId");
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.Lokacija", b =>
                {
                    b.HasOne("RMSLibrary.Models.DBModel.ProfilKompanije", "ProfilKompanija")
                        .WithMany("Lokacija")
                        .HasForeignKey("ProfilKompanijaId");

                    b.Navigation("ProfilKompanija");
                });
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.OglasiTable", b =>
                {
                    b.HasOne("RMSLibrary.Models.DBModel.ProfilKompanije", "ProfilKompanije")
                        .WithMany("Oglasi")
                        .HasForeignKey("ProfilKompanijeId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RMSLibrary.Models.DBModel.Status", b =>
                {
                    b.HasOne("RMSLibrary.Models.DBModel.Lokacija", "lokacija")
                        .WithMany("Status")
                        .HasForeignKey("LokacijaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
